...
public class GAME extends BIQSection{
    ...
    public int useDefaultRules = 1;
    public int defaultVictoryConditions = 1;
    ...
    public GAME(IO baselink)
    {
        ...
        turnsPerTimescalePart[0] =  25;
        turnsPerTimescalePart[1] =  25;
        turnsPerTimescalePart[2] =  40;
        turnsPerTimescalePart[3] =  50;
        turnsPerTimescalePart[4] = 100;
        turnsPerTimescalePart[5] = 100;
        turnsPerTimescalePart[6] = 100;
        timeUnitsPerTurn = new int[7];
        timeUnitsPerTurn[0] = 50;
        timeUnitsPerTurn[1] = 40;
        timeUnitsPerTurn[2] = 25;
        timeUnitsPerTurn[3] = 20;
        timeUnitsPerTurn[4] = 10;
        timeUnitsPerTurn[5] =  5;
        timeUnitsPerTurn[6] =  2;
